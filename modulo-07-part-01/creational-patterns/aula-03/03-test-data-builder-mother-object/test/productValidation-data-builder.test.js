...
describe('Test Data Builder', () => {
  ...
  it('should return an object when creating a Product with invalid id', () => {
  ...
  it('should return an object when creating a Product with invalid name', () => {
  ...
  it('should return an object when creating a Product with invalid price', () => {
  ...
  it('should return an object when creating a Product with invalid category', () => {
    const product = ProductDataBuilder.aProduct().withInvalidCategory().build();
    const result = productValidator(product);

    const expected = {
      errors: ["category: invalid value, current [mechanic] expected to be either electronic or organic"],
      result: false
    }
